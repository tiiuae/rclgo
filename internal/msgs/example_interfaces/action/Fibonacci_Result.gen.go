...
func Fibonacci_Result__Sequence_to_Go(goSlice *[]Fibonacci_Result, cSlice CFibonacci_Result__Sequence) {
	...
	*goSlice = make([]Fibonacci_Result, int64(cSlice.size))
	for i := 0; i < int(cSlice.size); i++ {
		cIdx := (*C.example_interfaces__action__Fibonacci_Result__Sequence)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_example_interfaces__action__Fibonacci_Result * uintptr(i)),
		))
...
func Fibonacci_Result__Sequence_to_C(cSlice *CFibonacci_Result__Sequence, goSlice []Fibonacci_Result) {
	...
	cSlice.data = (*C.example_interfaces__action__Fibonacci_Result)(C.malloc((C.size_t)(C.sizeof_struct_example_interfaces__action__Fibonacci_Result * uintptr(len(goSlice)))))
	cSlice.capacity = C.size_t(len(goSlice))
	cSlice.size = cSlice.capacity

	for i, v := range goSlice {
		cIdx := (*C.example_interfaces__action__Fibonacci_Result)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_example_interfaces__action__Fibonacci_Result * uintptr(i)),
		))

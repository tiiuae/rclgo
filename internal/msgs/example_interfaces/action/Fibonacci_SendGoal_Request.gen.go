...
func Fibonacci_SendGoal_Request__Sequence_to_Go(goSlice *[]Fibonacci_SendGoal_Request, cSlice CFibonacci_SendGoal_Request__Sequence) {
	...
	*goSlice = make([]Fibonacci_SendGoal_Request, int64(cSlice.size))
	for i := 0; i < int(cSlice.size); i++ {
		cIdx := (*C.example_interfaces__action__Fibonacci_SendGoal_Request__Sequence)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_example_interfaces__action__Fibonacci_SendGoal_Request * uintptr(i)),
		))
...
func Fibonacci_SendGoal_Request__Sequence_to_C(cSlice *CFibonacci_SendGoal_Request__Sequence, goSlice []Fibonacci_SendGoal_Request) {
	...
	cSlice.data = (*C.example_interfaces__action__Fibonacci_SendGoal_Request)(C.malloc((C.size_t)(C.sizeof_struct_example_interfaces__action__Fibonacci_SendGoal_Request * uintptr(len(goSlice)))))
	cSlice.capacity = C.size_t(len(goSlice))
	cSlice.size = cSlice.capacity

	for i, v := range goSlice {
		cIdx := (*C.example_interfaces__action__Fibonacci_SendGoal_Request)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_example_interfaces__action__Fibonacci_SendGoal_Request * uintptr(i)),
		))

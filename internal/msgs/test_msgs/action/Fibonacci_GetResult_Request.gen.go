...
func Fibonacci_GetResult_Request__Sequence_to_Go(goSlice *[]Fibonacci_GetResult_Request, cSlice CFibonacci_GetResult_Request__Sequence) {
	...
	*goSlice = make([]Fibonacci_GetResult_Request, int64(cSlice.size))
	for i := 0; i < int(cSlice.size); i++ {
		cIdx := (*C.test_msgs__action__Fibonacci_GetResult_Request__Sequence)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_test_msgs__action__Fibonacci_GetResult_Request * uintptr(i)),
		))
...
func Fibonacci_GetResult_Request__Sequence_to_C(cSlice *CFibonacci_GetResult_Request__Sequence, goSlice []Fibonacci_GetResult_Request) {
	...
	cSlice.data = (*C.test_msgs__action__Fibonacci_GetResult_Request)(C.malloc((C.size_t)(C.sizeof_struct_test_msgs__action__Fibonacci_GetResult_Request * uintptr(len(goSlice)))))
	cSlice.capacity = C.size_t(len(goSlice))
	cSlice.size = cSlice.capacity

	for i, v := range goSlice {
		cIdx := (*C.test_msgs__action__Fibonacci_GetResult_Request)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_test_msgs__action__Fibonacci_GetResult_Request * uintptr(i)),
		))

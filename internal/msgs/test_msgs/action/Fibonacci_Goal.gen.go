...
func Fibonacci_Goal__Sequence_to_Go(goSlice *[]Fibonacci_Goal, cSlice CFibonacci_Goal__Sequence) {
	...
	*goSlice = make([]Fibonacci_Goal, int64(cSlice.size))
	for i := 0; i < int(cSlice.size); i++ {
		cIdx := (*C.test_msgs__action__Fibonacci_Goal__Sequence)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_test_msgs__action__Fibonacci_Goal * uintptr(i)),
		))
...
func Fibonacci_Goal__Sequence_to_C(cSlice *CFibonacci_Goal__Sequence, goSlice []Fibonacci_Goal) {
	...
	cSlice.data = (*C.test_msgs__action__Fibonacci_Goal)(C.malloc((C.size_t)(C.sizeof_struct_test_msgs__action__Fibonacci_Goal * uintptr(len(goSlice)))))
	cSlice.capacity = C.size_t(len(goSlice))
	cSlice.size = cSlice.capacity

	for i, v := range goSlice {
		cIdx := (*C.test_msgs__action__Fibonacci_Goal)(unsafe.Pointer(
			uintptr(unsafe.Pointer(cSlice.data)) + (C.sizeof_struct_test_msgs__action__Fibonacci_Goal * uintptr(i)),
		))

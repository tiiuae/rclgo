...
type C{{.RosPackage}}__msg__{{.RosMsgName}}__Sequence = C.{{.RosPackage}}__msg__{{.RosMsgName}}__Sequence

func {{.RosMsgName}}__Sequence_to_Go(goSlice *[]{{.RosMsgName}}, cSlice C{{.RosPackage}}__msg__{{.RosMsgName}}__Sequence) {
...
func {{.RosMsgName}}__Sequence_to_C(cSlice *C{{.RosPackage}}__msg__{{.RosMsgName}}__Sequence, goSlice []{{.RosMsgName}}) {
...
func {{.RosMsgName}}__Array_to_Go(goSlice []{{.RosMsgName}}, cSlice []C{{.RosPackage}}__msg__{{.RosMsgName}}__Sequence) {
	for i := 0; i < len(cSlice); i++ {
		goSlice[i].AsGoStruct(unsafe.Pointer(&cSlice[i]))
	}
}
func {{.RosMsgName}}__Array_to_C(cSlice []C{{.RosPackage}}__msg__{{.RosMsgName}}__Sequence, goSlice []{{.RosMsgName}}) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.{{.RosPackage}}__msg__{{.RosMsgName}}__Sequence)(goSlice[i].AsCStruct())
	}
}
...
type Crosidl_runtime_c__{{.CStructName}}__Sequence = C.rosidl_runtime_c__{{.CStructName}}__Sequence

func {{.CStructName | ucFirst}}__Sequence_to_Go(goSlice *[]{{.GoType}}, cSlice Crosidl_runtime_c__{{.CStructName}}__Sequence) {
...
func {{.CStructName | ucFirst}}__Sequence_to_C(cSlice *Crosidl_runtime_c__{{.CStructName}}__Sequence, goSlice []{{.GoType}}) {
...
func {{.CStructName | ucFirst}}__Array_to_Go(goSlice []{{.GoType}}, cSlice []C{{.RosType | ucFirst}}) {
	for i := 0; i < len(cSlice); i++ {
		goSlice[i] = {{.GoType}}(cSlice[i])
	}
}
func Int64__Array_to_C(cSlice []C{{.RosType | ucFirst}}, goSlice []{{.GoType}}) {
	for i := 0; i < len(goSlice); i++ {

...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("example_interfaces/Empty", &Empty{})
}
...
func (t *Empty) PrepareMemory() unsafe.Pointer { //returns *C.example_interfaces__msg__Empty
...
func (t *Empty) AsCStruct() unsafe.Pointer {
	mem := (*C.example_interfaces__msg__Empty)(t.PrepareMemory())
...
func Empty__Sequence_to_C(cSlice *CEmpty__Sequence, goSlice []Empty) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.example_interfaces__msg__Empty)(v.AsCStruct())
	}
}
...
func Empty__Array_to_C(cSlice []CEmpty, goSlice []Empty) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.example_interfaces__msg__Empty)(goSlice[i].AsCStruct())
	}
}

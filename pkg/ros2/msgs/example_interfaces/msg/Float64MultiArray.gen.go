...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("example_interfaces/Float64MultiArray", &Float64MultiArray{})
}
...
func (t *Float64MultiArray) PrepareMemory() unsafe.Pointer { //returns *C.example_interfaces__msg__Float64MultiArray
...
func (t *Float64MultiArray) AsCStruct() unsafe.Pointer {
	mem := (*C.example_interfaces__msg__Float64MultiArray)(t.PrepareMemory())
...
func Float64MultiArray__Sequence_to_C(cSlice *CFloat64MultiArray__Sequence, goSlice []Float64MultiArray) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.example_interfaces__msg__Float64MultiArray)(v.AsCStruct())
	}
}
...
func Float64MultiArray__Array_to_C(cSlice []CFloat64MultiArray, goSlice []Float64MultiArray) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.example_interfaces__msg__Float64MultiArray)(goSlice[i].AsCStruct())
	}
}

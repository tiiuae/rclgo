...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("example_interfaces/Int16MultiArray", &Int16MultiArray{})
}
...
func (t *Int16MultiArray) PrepareMemory() unsafe.Pointer { //returns *C.example_interfaces__msg__Int16MultiArray
...
func (t *Int16MultiArray) AsCStruct() unsafe.Pointer {
	mem := (*C.example_interfaces__msg__Int16MultiArray)(t.PrepareMemory())
...
func Int16MultiArray__Sequence_to_C(cSlice *CInt16MultiArray__Sequence, goSlice []Int16MultiArray) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.example_interfaces__msg__Int16MultiArray)(v.AsCStruct())
	}
}
...
func Int16MultiArray__Array_to_C(cSlice []CInt16MultiArray, goSlice []Int16MultiArray) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.example_interfaces__msg__Int16MultiArray)(goSlice[i].AsCStruct())
	}
}

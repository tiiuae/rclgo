...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("example_interfaces/Int64MultiArray", Int64MultiArrayTypeSupport)
}
...
func (t _Int64MultiArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	rosidl_runtime_c.Int64__Sequence_to_C((*rosidl_runtime_c.CInt64__Sequence)(unsafe.Pointer(&mem.data)), m.Data)
}
...
func (t _Int64MultiArrayTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	rosidl_runtime_c.Int64__Sequence_to_Go(&m.Data, *(*rosidl_runtime_c.CInt64__Sequence)(unsafe.Pointer(&mem.data)))
}

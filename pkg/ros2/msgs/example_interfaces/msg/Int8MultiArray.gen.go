...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("example_interfaces/Int8MultiArray", Int8MultiArrayTypeSupport)
}
...
func (t *Int8MultiArray) Clone() types.Message {
	clone := *t
	return &clone
}

...
type MultiArrayLayout struct {
	Dim []std_msgs.MultiArrayDimension `yaml:"dim"`// Array of dimension properties
...
func (t *MultiArrayLayout) AsCStruct() unsafe.Pointer {
	...
	std_msgs.MultiArrayDimension__Sequence_to_C((*std_msgs.CMultiArrayDimension__Sequence)(unsafe.Pointer(&mem.dim)), t.Dim)
...
func (t *MultiArrayLayout) AsGoStruct(ros2_message_buffer unsafe.Pointer) {
	...
	std_msgs.MultiArrayDimension__Sequence_to_Go(&t.Dim, *(*std_msgs.CMultiArrayDimension__Sequence)(unsafe.Pointer(&mem.dim)))

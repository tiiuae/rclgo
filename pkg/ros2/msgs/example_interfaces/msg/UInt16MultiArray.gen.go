...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("example_interfaces/UInt16MultiArray", &UInt16MultiArray{})
}
...
func (t *UInt16MultiArray) SetDefaults(d interface{}) ros2types.ROS2Msg {
	t.Layout.SetDefaults(nil)
	
	return t
}

func (t *UInt16MultiArray) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__example_interfaces__msg__UInt16MultiArray())
}
func (t *UInt16MultiArray) PrepareMemory() unsafe.Pointer { //returns *C.example_interfaces__msg__UInt16MultiArray
	return (unsafe.Pointer)(C.example_interfaces__msg__UInt16MultiArray__create())
}
func (t *UInt16MultiArray) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.example_interfaces__msg__UInt16MultiArray__destroy((*C.example_interfaces__msg__UInt16MultiArray)(pointer_to_free))
}
func (t *UInt16MultiArray) AsCStruct() unsafe.Pointer {
	mem := (*C.example_interfaces__msg__UInt16MultiArray)(t.PrepareMemory())
	mem.layout = *(*C.example_interfaces__msg__MultiArrayLayout)(t.Layout.AsCStruct())
	rosidl_runtime_c.Uint16__Sequence_to_C((*rosidl_runtime_c.CUint16__Sequence)(unsafe.Pointer(&mem.data)), t.Data)
	return unsafe.Pointer(mem)
}
func (t *UInt16MultiArray) AsGoStruct(ros2_message_buffer unsafe.Pointer) {
	mem := (*C.example_interfaces__msg__UInt16MultiArray)(ros2_message_buffer)
	t.Layout.AsGoStruct(unsafe.Pointer(&mem.layout))
	rosidl_runtime_c.Uint16__Sequence_to_Go(&t.Data, *(*rosidl_runtime_c.CUint16__Sequence)(unsafe.Pointer(&mem.data)))
}
func (t *UInt16MultiArray) Clone() ros2types.ROS2Msg {
	clone := *t
	return &clone
}
...
func UInt16MultiArray__Sequence_to_C(cSlice *CUInt16MultiArray__Sequence, goSlice []UInt16MultiArray) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.example_interfaces__msg__UInt16MultiArray)(v.AsCStruct())
	}
}
...
func UInt16MultiArray__Array_to_C(cSlice []CUInt16MultiArray, goSlice []UInt16MultiArray) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.example_interfaces__msg__UInt16MultiArray)(goSlice[i].AsCStruct())
	}
}

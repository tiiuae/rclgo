...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("example_interfaces/Trigger_Request", &Trigger_Request{})
}
...
func (t *Trigger_Request) PrepareMemory() unsafe.Pointer { //returns *C.example_interfaces__srv__Trigger_Request
...
func (t *Trigger_Request) AsCStruct() unsafe.Pointer {
	mem := (*C.example_interfaces__srv__Trigger_Request)(t.PrepareMemory())
...
func Trigger_Request__Sequence_to_C(cSlice *CTrigger_Request__Sequence, goSlice []Trigger_Request) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.example_interfaces__srv__Trigger_Request)(v.AsCStruct())
	}
}
...
func Trigger_Request__Array_to_C(cSlice []CTrigger_Request, goSlice []Trigger_Request) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.example_interfaces__srv__Trigger_Request)(goSlice[i].AsCStruct())
	}
}

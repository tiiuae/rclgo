...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("geometry_msgs/AccelWithCovarianceStamped", AccelWithCovarianceStampedTypeSupport)
}
...
func (t *AccelWithCovarianceStamped) Clone() types.Message {
	clone := *t
	return &clone
}

...
type GridCells struct {
	...
	Cells []geometry_msgs.Point `yaml:"cells"`// Each cell is represented by the Point at the center of the cell
}
...
func (t *GridCells) AsCStruct() unsafe.Pointer {
	...
	geometry_msgs.Point__Sequence_to_C((*geometry_msgs.CPoint__Sequence)(unsafe.Pointer(&mem.cells)), t.Cells)
...
func (t *GridCells) AsGoStruct(ros2_message_buffer unsafe.Pointer) {
	...
	geometry_msgs.Point__Sequence_to_Go(&t.Cells, *(*geometry_msgs.CPoint__Sequence)(unsafe.Pointer(&mem.cells)))
}

...
type MapMetaData struct {
	MapLoadTime builtin_interfaces.Time `yaml:"map_load_time"`// The time at which the map was loaded
	...
	Origin geometry_msgs.Pose `yaml:"origin"`// The origin of the map [m, m, rad].  This is the real-world pose of thebottom left corner of cell (0,0) in the map.
}

...
type PolygonMesh struct {
	Header std_msgs.Header `yaml:"header"`// Separate header for the polygonal surface
	Cloud sensor_msgs.PointCloud2 `yaml:"cloud"`// Separate header for the polygonal surfaceVertices of the mesh as a point cloud

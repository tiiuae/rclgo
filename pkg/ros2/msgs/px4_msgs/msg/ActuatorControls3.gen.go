...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("px4_msgs/ActuatorControls3", &ActuatorControls3{})
}
const (
...
func (t *ActuatorControls3) SetDefaults(d interface{}) ros2types.ROS2Msg {
	
	return t
}

func (t *ActuatorControls3) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__px4_msgs__msg__ActuatorControls3())
}
func (t *ActuatorControls3) PrepareMemory() unsafe.Pointer { //returns *C.px4_msgs__msg__ActuatorControls3
	return (unsafe.Pointer)(C.px4_msgs__msg__ActuatorControls3__create())
}
func (t *ActuatorControls3) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.px4_msgs__msg__ActuatorControls3__destroy((*C.px4_msgs__msg__ActuatorControls3)(pointer_to_free))
}
func (t *ActuatorControls3) AsCStruct() unsafe.Pointer {
	mem := (*C.px4_msgs__msg__ActuatorControls3)(t.PrepareMemory())
...
func (t *ActuatorControls3) AsGoStruct(ros2_message_buffer unsafe.Pointer) {
...
func (t *ActuatorControls3) Clone() ros2types.ROS2Msg {
	clone := *t
	return &clone
}
...
func ActuatorControls3__Sequence_to_C(cSlice *CActuatorControls3__Sequence, goSlice []ActuatorControls3) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.px4_msgs__msg__ActuatorControls3)(v.AsCStruct())
	}
}
...
func ActuatorControls3__Array_to_C(cSlice []CActuatorControls3, goSlice []ActuatorControls3) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.px4_msgs__msg__ActuatorControls3)(goSlice[i].AsCStruct())
	}
}

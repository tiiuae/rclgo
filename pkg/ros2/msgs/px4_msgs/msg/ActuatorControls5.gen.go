...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("px4_msgs/ActuatorControls5", &ActuatorControls5{})
}
const (
...
func (t *ActuatorControls5) SetDefaults(d interface{}) ros2types.ROS2Msg {
	
	return t
}

func (t *ActuatorControls5) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__px4_msgs__msg__ActuatorControls5())
}
func (t *ActuatorControls5) PrepareMemory() unsafe.Pointer { //returns *C.px4_msgs__msg__ActuatorControls5
	return (unsafe.Pointer)(C.px4_msgs__msg__ActuatorControls5__create())
}
func (t *ActuatorControls5) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.px4_msgs__msg__ActuatorControls5__destroy((*C.px4_msgs__msg__ActuatorControls5)(pointer_to_free))
}
func (t *ActuatorControls5) AsCStruct() unsafe.Pointer {
	mem := (*C.px4_msgs__msg__ActuatorControls5)(t.PrepareMemory())
...
func (t *ActuatorControls5) AsGoStruct(ros2_message_buffer unsafe.Pointer) {
...
func (t *ActuatorControls5) Clone() ros2types.ROS2Msg {
	clone := *t
	return &clone
}
...
func ActuatorControls5__Sequence_to_C(cSlice *CActuatorControls5__Sequence, goSlice []ActuatorControls5) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.px4_msgs__msg__ActuatorControls5)(v.AsCStruct())
	}
}
...
func ActuatorControls5__Array_to_C(cSlice []CActuatorControls5, goSlice []ActuatorControls5) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.px4_msgs__msg__ActuatorControls5)(goSlice[i].AsCStruct())
	}
}

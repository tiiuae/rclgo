...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("px4_msgs/EstimatorLocalPosition", EstimatorLocalPositionTypeSupport)
}
const (
...
func (t *EstimatorLocalPosition) Clone() types.Message {
	clone := *t
	return &clone
}
...
type _EstimatorLocalPositionTypeSupport struct{}

func (t _EstimatorLocalPositionTypeSupport) New() types.Message {
	return NewEstimatorLocalPosition()
}

func (t _EstimatorLocalPositionTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.px4_msgs__msg__EstimatorLocalPosition
	return (unsafe.Pointer)(C.px4_msgs__msg__EstimatorLocalPosition__create())
}

func (t _EstimatorLocalPositionTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.px4_msgs__msg__EstimatorLocalPosition__destroy((*C.px4_msgs__msg__EstimatorLocalPosition)(pointer_to_free))
}

func (t _EstimatorLocalPositionTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*EstimatorLocalPosition)
	mem := (*C.px4_msgs__msg__EstimatorLocalPosition)(dst)
...
func (t _EstimatorLocalPositionTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*EstimatorLocalPosition)
...
func (t _EstimatorLocalPositionTypeSupport) TypeSupport() unsafe.Pointer {
...
func EstimatorLocalPosition__Sequence_to_Go(goSlice *[]EstimatorLocalPosition, cSlice CEstimatorLocalPosition__Sequence) {
	...
	*goSlice = make([]EstimatorLocalPosition, int64(cSlice.size))
	for i := 0; i < int(cSlice.size); i++ {
		...
		EstimatorLocalPositionTypeSupport.AsGoStruct(&(*goSlice)[i], unsafe.Pointer(cIdx))
	}
}
func EstimatorLocalPosition__Sequence_to_C(cSlice *CEstimatorLocalPosition__Sequence, goSlice []EstimatorLocalPosition) {
	...
	for i, v := range goSlice {
		...
		EstimatorLocalPositionTypeSupport.AsCStruct(unsafe.Pointer(cIdx), &v)
	}
}
func EstimatorLocalPosition__Array_to_Go(goSlice []EstimatorLocalPosition, cSlice []CEstimatorLocalPosition) {
	for i := 0; i < len(cSlice); i++ {
		EstimatorLocalPositionTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}
func EstimatorLocalPosition__Array_to_C(cSlice []CEstimatorLocalPosition, goSlice []EstimatorLocalPosition) {
	for i := 0; i < len(goSlice); i++ {
		EstimatorLocalPositionTypeSupport.AsCStruct(unsafe.Pointer(&cSlice[i]), &goSlice[i])
	}
}

...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("px4_msgs/SensorGyroFft", SensorGyroFftTypeSupport)
}
...
func (t _SensorGyroFftTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	rosidl_runtime_c.Float32__Array_to_C(*(*[]rosidl_runtime_c.CFloat32)(unsafe.Pointer(&cSlice_peak_frequencies_x)), m.PeakFrequenciesX[:])
	cSlice_peak_frequencies_y := mem.peak_frequencies_y[:]
	rosidl_runtime_c.Float32__Array_to_C(*(*[]rosidl_runtime_c.CFloat32)(unsafe.Pointer(&cSlice_peak_frequencies_y)), m.PeakFrequenciesY[:])
	cSlice_peak_frequencies_z := mem.peak_frequencies_z[:]
	rosidl_runtime_c.Float32__Array_to_C(*(*[]rosidl_runtime_c.CFloat32)(unsafe.Pointer(&cSlice_peak_frequencies_z)), m.PeakFrequenciesZ[:])
	cSlice_peak_magnitude_x := mem.peak_magnitude_x[:]
	rosidl_runtime_c.Uint32__Array_to_C(*(*[]rosidl_runtime_c.CUint32)(unsafe.Pointer(&cSlice_peak_magnitude_x)), m.PeakMagnitudeX[:])
	cSlice_peak_magnitude_y := mem.peak_magnitude_y[:]
	rosidl_runtime_c.Uint32__Array_to_C(*(*[]rosidl_runtime_c.CUint32)(unsafe.Pointer(&cSlice_peak_magnitude_y)), m.PeakMagnitudeY[:])
	cSlice_peak_magnitude_z := mem.peak_magnitude_z[:]
	rosidl_runtime_c.Uint32__Array_to_C(*(*[]rosidl_runtime_c.CUint32)(unsafe.Pointer(&cSlice_peak_magnitude_z)), m.PeakMagnitudeZ[:])
}
...
func (t _SensorGyroFftTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	cSlice_peak_frequencies_x := mem.peak_frequencies_x[:]
	rosidl_runtime_c.Float32__Array_to_Go(m.PeakFrequenciesX[:], *(*[]rosidl_runtime_c.CFloat32)(unsafe.Pointer(&cSlice_peak_frequencies_x)))
	cSlice_peak_frequencies_y := mem.peak_frequencies_y[:]
	rosidl_runtime_c.Float32__Array_to_Go(m.PeakFrequenciesY[:], *(*[]rosidl_runtime_c.CFloat32)(unsafe.Pointer(&cSlice_peak_frequencies_y)))
	cSlice_peak_frequencies_z := mem.peak_frequencies_z[:]
	rosidl_runtime_c.Float32__Array_to_Go(m.PeakFrequenciesZ[:], *(*[]rosidl_runtime_c.CFloat32)(unsafe.Pointer(&cSlice_peak_frequencies_z)))
	cSlice_peak_magnitude_x := mem.peak_magnitude_x[:]
	rosidl_runtime_c.Uint32__Array_to_Go(m.PeakMagnitudeX[:], *(*[]rosidl_runtime_c.CUint32)(unsafe.Pointer(&cSlice_peak_magnitude_x)))
	cSlice_peak_magnitude_y := mem.peak_magnitude_y[:]
	rosidl_runtime_c.Uint32__Array_to_Go(m.PeakMagnitudeY[:], *(*[]rosidl_runtime_c.CUint32)(unsafe.Pointer(&cSlice_peak_magnitude_y)))
	cSlice_peak_magnitude_z := mem.peak_magnitude_z[:]
	rosidl_runtime_c.Uint32__Array_to_Go(m.PeakMagnitudeZ[:], *(*[]rosidl_runtime_c.CUint32)(unsafe.Pointer(&cSlice_peak_magnitude_z)))
}

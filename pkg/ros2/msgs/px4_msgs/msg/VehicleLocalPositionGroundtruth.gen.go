...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("px4_msgs/VehicleLocalPositionGroundtruth", VehicleLocalPositionGroundtruthTypeSupport)
}
const (
...
type _VehicleLocalPositionGroundtruthTypeSupport struct{}

func (t _VehicleLocalPositionGroundtruthTypeSupport) New() types.Message {
	return NewVehicleLocalPositionGroundtruth()
}

func (t _VehicleLocalPositionGroundtruthTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.px4_msgs__msg__VehicleLocalPositionGroundtruth
	return (unsafe.Pointer)(C.px4_msgs__msg__VehicleLocalPositionGroundtruth__create())
}

func (t _VehicleLocalPositionGroundtruthTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
...
func (t _VehicleLocalPositionGroundtruthTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*VehicleLocalPositionGroundtruth)
	mem := (*C.px4_msgs__msg__VehicleLocalPositionGroundtruth)(dst)
...
func (t _VehicleLocalPositionGroundtruthTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*VehicleLocalPositionGroundtruth)
...
func (t _VehicleLocalPositionGroundtruthTypeSupport) TypeSupport() unsafe.Pointer {
...
func VehicleLocalPositionGroundtruth__Sequence_to_Go(goSlice *[]VehicleLocalPositionGroundtruth, cSlice CVehicleLocalPositionGroundtruth__Sequence) {
	...
	*goSlice = make([]VehicleLocalPositionGroundtruth, int64(cSlice.size))
	for i := 0; i < int(cSlice.size); i++ {
		...
		VehicleLocalPositionGroundtruthTypeSupport.AsGoStruct(&(*goSlice)[i], unsafe.Pointer(cIdx))
	}
}
func VehicleLocalPositionGroundtruth__Sequence_to_C(cSlice *CVehicleLocalPositionGroundtruth__Sequence, goSlice []VehicleLocalPositionGroundtruth) {
	...
	for i, v := range goSlice {
		...
		VehicleLocalPositionGroundtruthTypeSupport.AsCStruct(unsafe.Pointer(cIdx), &v)
	}
}
func VehicleLocalPositionGroundtruth__Array_to_Go(goSlice []VehicleLocalPositionGroundtruth, cSlice []CVehicleLocalPositionGroundtruth) {
	for i := 0; i < len(cSlice); i++ {
		VehicleLocalPositionGroundtruthTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}
func VehicleLocalPositionGroundtruth__Array_to_C(cSlice []CVehicleLocalPositionGroundtruth, goSlice []VehicleLocalPositionGroundtruth) {
	for i := 0; i < len(goSlice); i++ {
		VehicleLocalPositionGroundtruthTypeSupport.AsCStruct(unsafe.Pointer(&cSlice[i]), &goSlice[i])
	}
}

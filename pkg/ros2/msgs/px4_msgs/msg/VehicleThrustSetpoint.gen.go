...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("px4_msgs/VehicleThrustSetpoint", VehicleThrustSetpointTypeSupport)
}
...
func (t *VehicleThrustSetpoint) Clone() types.Message {
	clone := *t
	return &clone
}

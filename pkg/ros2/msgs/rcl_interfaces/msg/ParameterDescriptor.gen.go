...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("rcl_interfaces/ParameterDescriptor", ParameterDescriptorTypeSupport)
}
...
func (t _ParameterDescriptorTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	rosidl_runtime_c.StringAsCStruct(unsafe.Pointer(&mem.additional_constraints), m.AdditionalConstraints)
...
func (t _ParameterDescriptorTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	rosidl_runtime_c.StringAsGoStruct(&m.AdditionalConstraints, unsafe.Pointer(&mem.additional_constraints))

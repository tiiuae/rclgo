...
// function instead.
type Clock struct {
	Clock builtin_interfaces.Time `yaml:"clock"`// This message communicates the current time.For more information, see https://design.ros2.org/articles/clock_and_time.html.
}

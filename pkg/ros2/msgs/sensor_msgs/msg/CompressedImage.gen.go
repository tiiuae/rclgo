...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("sensor_msgs/CompressedImage", CompressedImageTypeSupport)
}
...
func (t _CompressedImageTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	rosidl_runtime_c.StringAsCStruct(unsafe.Pointer(&mem.format), m.Format)
...
func (t _CompressedImageTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	rosidl_runtime_c.StringAsGoStruct(&m.Format, unsafe.Pointer(&mem.format))

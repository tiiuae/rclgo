...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("std_msgs/ByteMultiArray", &ByteMultiArray{})
}
...
func (t *ByteMultiArray) PrepareMemory() unsafe.Pointer { //returns *C.std_msgs__msg__ByteMultiArray
...
func (t *ByteMultiArray) AsCStruct() unsafe.Pointer {
	mem := (*C.std_msgs__msg__ByteMultiArray)(t.PrepareMemory())
...
func ByteMultiArray__Sequence_to_C(cSlice *CByteMultiArray__Sequence, goSlice []ByteMultiArray) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.std_msgs__msg__ByteMultiArray)(v.AsCStruct())
	}
}
...
func ByteMultiArray__Array_to_C(cSlice []CByteMultiArray, goSlice []ByteMultiArray) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.std_msgs__msg__ByteMultiArray)(goSlice[i].AsCStruct())
	}
}

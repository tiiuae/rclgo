...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("std_msgs/Float32MultiArray", &Float32MultiArray{})
}
...
func (t *Float32MultiArray) PrepareMemory() unsafe.Pointer { //returns *C.std_msgs__msg__Float32MultiArray
...
func (t *Float32MultiArray) AsCStruct() unsafe.Pointer {
	mem := (*C.std_msgs__msg__Float32MultiArray)(t.PrepareMemory())
...
func Float32MultiArray__Sequence_to_C(cSlice *CFloat32MultiArray__Sequence, goSlice []Float32MultiArray) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.std_msgs__msg__Float32MultiArray)(v.AsCStruct())
	}
}
...
func Float32MultiArray__Array_to_C(cSlice []CFloat32MultiArray, goSlice []Float32MultiArray) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.std_msgs__msg__Float32MultiArray)(goSlice[i].AsCStruct())
	}
}

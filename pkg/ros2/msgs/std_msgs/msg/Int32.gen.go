...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("std_msgs/Int32", &Int32{})
}
...
func (t *Int32) PrepareMemory() unsafe.Pointer { //returns *C.std_msgs__msg__Int32
...
func (t *Int32) AsCStruct() unsafe.Pointer {
	mem := (*C.std_msgs__msg__Int32)(t.PrepareMemory())
...
func Int32__Sequence_to_C(cSlice *CInt32__Sequence, goSlice []Int32) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.std_msgs__msg__Int32)(v.AsCStruct())
	}
}
...
func Int32__Array_to_C(cSlice []CInt32, goSlice []Int32) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.std_msgs__msg__Int32)(goSlice[i].AsCStruct())
	}
}

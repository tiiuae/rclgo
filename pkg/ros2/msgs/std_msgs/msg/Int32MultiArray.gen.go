...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("std_msgs/Int32MultiArray", &Int32MultiArray{})
}
...
func (t *Int32MultiArray) PrepareMemory() unsafe.Pointer { //returns *C.std_msgs__msg__Int32MultiArray
...
func (t *Int32MultiArray) AsCStruct() unsafe.Pointer {
	mem := (*C.std_msgs__msg__Int32MultiArray)(t.PrepareMemory())
...
func Int32MultiArray__Sequence_to_C(cSlice *CInt32MultiArray__Sequence, goSlice []Int32MultiArray) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.std_msgs__msg__Int32MultiArray)(v.AsCStruct())
	}
}
...
func Int32MultiArray__Array_to_C(cSlice []CInt32MultiArray, goSlice []Int32MultiArray) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.std_msgs__msg__Int32MultiArray)(goSlice[i].AsCStruct())
	}
}

...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("std_msgs/Int64MultiArray", &Int64MultiArray{})
}
...
func (t *Int64MultiArray) PrepareMemory() unsafe.Pointer { //returns *C.std_msgs__msg__Int64MultiArray
...
func (t *Int64MultiArray) AsCStruct() unsafe.Pointer {
	mem := (*C.std_msgs__msg__Int64MultiArray)(t.PrepareMemory())
...
func Int64MultiArray__Sequence_to_C(cSlice *CInt64MultiArray__Sequence, goSlice []Int64MultiArray) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.std_msgs__msg__Int64MultiArray)(v.AsCStruct())
	}
}
...
func Int64MultiArray__Array_to_C(cSlice []CInt64MultiArray, goSlice []Int64MultiArray) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.std_msgs__msg__Int64MultiArray)(goSlice[i].AsCStruct())
	}
}

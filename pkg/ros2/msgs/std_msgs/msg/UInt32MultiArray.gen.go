...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("std_msgs/UInt32MultiArray", UInt32MultiArrayTypeSupport)
}
...
func (t _UInt32MultiArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	rosidl_runtime_c.Uint32__Sequence_to_C((*rosidl_runtime_c.CUint32__Sequence)(unsafe.Pointer(&mem.data)), m.Data)
}
...
func (t _UInt32MultiArrayTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	rosidl_runtime_c.Uint32__Sequence_to_Go(&m.Data, *(*rosidl_runtime_c.CUint32__Sequence)(unsafe.Pointer(&mem.data)))
}

...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("std_msgs/UInt32MultiArray", &UInt32MultiArray{})
}
...
func (t *UInt32MultiArray) PrepareMemory() unsafe.Pointer { //returns *C.std_msgs__msg__UInt32MultiArray
...
func (t *UInt32MultiArray) AsCStruct() unsafe.Pointer {
	mem := (*C.std_msgs__msg__UInt32MultiArray)(t.PrepareMemory())
...
func UInt32MultiArray__Sequence_to_C(cSlice *CUInt32MultiArray__Sequence, goSlice []UInt32MultiArray) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.std_msgs__msg__UInt32MultiArray)(v.AsCStruct())
	}
}
...
func UInt32MultiArray__Array_to_C(cSlice []CUInt32MultiArray, goSlice []UInt32MultiArray) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.std_msgs__msg__UInt32MultiArray)(goSlice[i].AsCStruct())
	}
}

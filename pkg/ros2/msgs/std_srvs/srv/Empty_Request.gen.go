...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("std_srvs/Empty_Request", &Empty_Request{})
}
...
func (t *Empty_Request) PrepareMemory() unsafe.Pointer { //returns *C.std_srvs__srv__Empty_Request
...
func (t *Empty_Request) AsCStruct() unsafe.Pointer {
	mem := (*C.std_srvs__srv__Empty_Request)(t.PrepareMemory())
...
func Empty_Request__Sequence_to_C(cSlice *CEmpty_Request__Sequence, goSlice []Empty_Request) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.std_srvs__srv__Empty_Request)(v.AsCStruct())
	}
}
...
func Empty_Request__Array_to_C(cSlice []CEmpty_Request, goSlice []Empty_Request) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.std_srvs__srv__Empty_Request)(goSlice[i].AsCStruct())
	}
}

...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("test_msgs/Arrays_Request", &Arrays_Request{})
}
...
func (t *Arrays_Request) SetDefaults(d interface{}) ros2types.ROS2Msg {
...
func (t *Arrays_Request) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__test_msgs__srv__Arrays_Request())
}
func (t *Arrays_Request) PrepareMemory() unsafe.Pointer { //returns *C.test_msgs__srv__Arrays_Request
	return (unsafe.Pointer)(C.test_msgs__srv__Arrays_Request__create())
}
func (t *Arrays_Request) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.test_msgs__srv__Arrays_Request__destroy((*C.test_msgs__srv__Arrays_Request)(pointer_to_free))
}
func (t *Arrays_Request) AsCStruct() unsafe.Pointer {
	mem := (*C.test_msgs__srv__Arrays_Request)(t.PrepareMemory())
...
func (t *Arrays_Request) AsGoStruct(ros2_message_buffer unsafe.Pointer) {
...
func (t *Arrays_Request) Clone() ros2types.ROS2Msg {
	clone := *t
	return &clone
}
...
func Arrays_Request__Sequence_to_C(cSlice *CArrays_Request__Sequence, goSlice []Arrays_Request) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.test_msgs__srv__Arrays_Request)(v.AsCStruct())
	}
}
...
func Arrays_Request__Array_to_C(cSlice []CArrays_Request, goSlice []Arrays_Request) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.test_msgs__srv__Arrays_Request)(goSlice[i].AsCStruct())
	}
}

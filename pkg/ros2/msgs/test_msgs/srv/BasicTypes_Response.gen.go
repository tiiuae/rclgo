...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("test_msgs/BasicTypes_Response", BasicTypes_ResponseTypeSupport)
}
...
func (t *BasicTypes_Response) Clone() types.Message {
	clone := *t
	return &clone
}

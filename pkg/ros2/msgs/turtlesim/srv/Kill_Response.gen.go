...
func init() {
	ros2_type_dispatcher.RegisterROS2MsgTypeNameAlias("turtlesim/Kill_Response", &Kill_Response{})
}
...
func (t *Kill_Response) SetDefaults(d interface{}) ros2types.ROS2Msg {
	
	return t
}

func (t *Kill_Response) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__turtlesim__srv__Kill_Response())
}
func (t *Kill_Response) PrepareMemory() unsafe.Pointer { //returns *C.turtlesim__srv__Kill_Response
	return (unsafe.Pointer)(C.turtlesim__srv__Kill_Response__create())
}
func (t *Kill_Response) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.turtlesim__srv__Kill_Response__destroy((*C.turtlesim__srv__Kill_Response)(pointer_to_free))
}
func (t *Kill_Response) AsCStruct() unsafe.Pointer {
	mem := (*C.turtlesim__srv__Kill_Response)(t.PrepareMemory())
	return unsafe.Pointer(mem)
}
func (t *Kill_Response) AsGoStruct(ros2_message_buffer unsafe.Pointer) {
	
}
func (t *Kill_Response) Clone() ros2types.ROS2Msg {
	clone := *t
	return &clone
}
...
func Kill_Response__Sequence_to_C(cSlice *CKill_Response__Sequence, goSlice []Kill_Response) {
	...
	for i, v := range goSlice {
		...
		*cIdx = *(*C.turtlesim__srv__Kill_Response)(v.AsCStruct())
	}
}
...
func Kill_Response__Array_to_C(cSlice []CKill_Response, goSlice []Kill_Response) {
	for i := 0; i < len(goSlice); i++ {
		cSlice[i] = *(*C.turtlesim__srv__Kill_Response)(goSlice[i].AsCStruct())
	}
}

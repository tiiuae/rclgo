...
// function instead.
type Marker struct {
	Header std_msgs.Header `yaml:"header"`// Header for timestamp and frame id.
...
func (t *Marker) AsCStruct() unsafe.Pointer {
	...
	std_msgs.ColorRGBA__Sequence_to_C((*std_msgs.CColorRGBA__Sequence)(unsafe.Pointer(&mem.colors)), t.Colors)
...
func (t *Marker) AsGoStruct(ros2_message_buffer unsafe.Pointer) {
	...
	std_msgs.ColorRGBA__Sequence_to_Go(&t.Colors, *(*std_msgs.CColorRGBA__Sequence)(unsafe.Pointer(&mem.colors)))
